...
te = traceHandler_works.traceExtractor(config)
...
plt.title('Uncorrected CsI PHD (Interval: ['+str(SIL)+' $\mu s$, '+str(SIU)+'$\mu s$])',**myFont)
plt.ylabel('Number of Events [$N$]',**myFont)
plt.xlabel('-1$\cdot$Summed Voltage[$mV$]',**myFont)
...
plt.title('Uncorrected WSL Fiber PHD (Interval: ['+str(SIL)+' $\mu s$, '+str(SIU)+'$\mu s$])',**myFont)
plt.ylabel('Number of Events [$N$]',**myFont)
plt.xlabel('-1$\cdot$Summed Voltage[$mV$]',**myFont)
...
plt.figure(figsize=(9,6), dpi=100)
bins = np.linspace(np.min(signalSumsFull[:,0]),np.max(signalSumsFull[:,0]),100)
plt.title('Corrected CsI PHD (Interval: ['+str(SIL)+' $\mu s$, '+str(SIU)+'$\mu s$])',**myFont)
plt.ylabel('Number of Events [$N$]',**myFont)
plt.xlabel('-1$\cdot$Summed Voltage[$mV$]',**myFont)
...
plt.figure(figsize=(9,6), dpi=100)
bins = np.linspace(np.min(signalSumsFull[:,1]),np.max(signalSumsFull[:,1]),100)
plt.title('Corrected WSL Fiber PHD (Interval: ['+str(SIL)+' $\mu s$, '+str(SIU)+'$\mu s$])',**myFont)
plt.ylabel('Number of Events [$N$]',**myFont)
plt.xlabel('-1$\cdot$Summed Voltage[$mV$]',**myFont)
...
plt.figure(figsize=(9,6), dpi=100)
bins = np.linspace(np.min(signalSumsFull[:,0]),np.max(signalSumsFull[:,0]),100)
plt.title('Rejected CsI PHD (Interval: ['+str(SIL)+' $\mu s$, '+str(SIU)+'$\mu s$])',**myFont)
plt.ylabel('Number of Events [$N$]',**myFont)
plt.xlabel('-1$\cdot$Summed Voltage[$mV$]',**myFont)
...
plt.figure(figsize=(9,6), dpi=100)
bins = np.linspace(np.min(signalSumsFull[:,1]),np.max(signalSumsFull[:,1]),100)
plt.title('Rejected WSL Fiber PHD (Interval: ['+str(SIL)+' $\mu s$, '+str(SIU)+'$\mu s$])',**myFont)
plt.ylabel('Number of Events [$N$]',**myFont)
plt.xlabel('-1$\cdot$Summed Voltage[$mV$]',**myFont)
