...
if te.doPlots == True:
	...
	if te.doPhotonCounting == True:
		te.plotPhotons(te.photonFiles, bins=binsY, labels=['-0.5V', '-1V', '-1.5V', '-2V'], title='Photon arrival with varying trigger level',
			filename=str(te.plotsDir/'allPhotons.png'), show=te.showPlots, save=te.savePlots)
